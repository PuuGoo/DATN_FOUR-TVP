		...
		<div class="sidebar-wrapper" data-simplebar="true">
			...
			<ul class="metismenu" id="menu">
				...
				{{-- <li>
					...
					<ul>
						<li> <a href="all/subcategory"><i class="bx bx-right-arrow-alt"></i>All SubCategory</a>
						</li>
						<li> <a href="add/subcategory"><i class="bx bx-right-arrow-alt"></i>Add SubCategory</a>
						</li>
