	    ...
	    <div class="container">
	        <div class="section-title style-2 wow animate__animated animate__fadeIn">
	            ...
	            <ul class="nav nav-tabs links" id="myTab" role="tablist">
	                ...
	                <li class="nav-item" role="presentation">
	                    <a class="nav-link" id="nav-tab-two" data-bs-toggle="tab" href="#category4" type="button" role="tab" aria-controls="tab-two" aria-selected="false">Appliances</a>
	                </li>
	                <li class="nav-item" role="presentation">
	                    <a class="nav-link" id="nav-tab-two" data-bs-toggle="tab" href="#category5" type="button" role="tab" aria-controls="tab-two" aria-selected="false">Beauty</a>
	                </li>
	                <li class="nav-item" role="presentation">
	                    <a class="nav-link" id="nav-tab-two" data-bs-toggle="tab" href="#category2" type="button" role="tab" aria-controls="tab-two" aria-selected="false">Electronics</a>
	                </li>
	                <li class="nav-item" role="presentation">
	                    <a class="nav-link" id="nav-tab-two" data-bs-toggle="tab" href="#category1" type="button" role="tab" aria-controls="tab-two" aria-selected="false">Fashion</a>
	                </li>
	                <li class="nav-item" role="presentation">
	                    <a class="nav-link" id="nav-tab-two" data-bs-toggle="tab" href="#category8" type="button" role="tab" aria-controls="tab-two" aria-selected="false">Furniture</a>
	                </li>
	                <li class="nav-item" role="presentation">
	                    <a class="nav-link" id="nav-tab-two" data-bs-toggle="tab" href="#category10" type="button" role="tab" aria-controls="tab-two" aria-selected="false">Grocery</a>
	                </li>
	                <li class="nav-item" role="presentation">
	                    <a class="nav-link" id="nav-tab-two" data-bs-toggle="tab" href="#category7" type="button" role="tab" aria-controls="tab-two" aria-selected="false">Meat &amp; Fish</a>
	                </li>
	                <li class="nav-item" role="presentation">
	                    <a class="nav-link" id="nav-tab-two" data-bs-toggle="tab" href="#category9" type="button" role="tab" aria-controls="tab-two" aria-selected="false">Mobiles</a>
	                </li>
	                <li class="nav-item" role="presentation">
	                    <a class="nav-link" id="nav-tab-two" data-bs-toggle="tab" href="#category3" type="button" role="tab" aria-controls="tab-two" aria-selected="false">Sweet Home</a>
	                </li>
	                <li class="nav-item" role="presentation">
	                    <a class="nav-link" id="nav-tab-two" data-bs-toggle="tab" href="#category11" type="button" role="tab" aria-controls="tab-two" aria-selected="false">Travel</a>
	                </li>
	            </ul>
	        </div>
	        <!--End nav-tabs-->
	        <div class="tab-content" id="myTabContent">
	                ...
	                <div class="row product-grid-4">
	                        ...
	                        <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
	                            <div class="product-img-action-wrap">
	                                <div class="product-img product-img-zoom">
	                                    <a href="https://digi-poly.id.vn/product/details/6/color-block-men-hooded-neck-red">
	                                        <img class="default-img" src="https://digi-poly.id.vn/upload/products/thambnail/1740389527616484.webp" alt="" />

	                                    </a>
	                                </div>
	                                <div class="product-action-1">

	                                    <a aria-label="Add To Wishlist" class="action-btn" id="6" onclick="addToWishList(this.id)"><i class="fi-rs-heart"></i></a>
	                    ...
	                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
	                        <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
	                            <div class="product-img-action-wrap">
	                                <div class="product-img product-img-zoom">
	                                    <a href="https://digi-poly.id.vn/product/details/7/men-regular-fit-solid-button-down">
	                                        <img class="default-img" src="https://digi-poly.id.vn/upload/products/thambnail/1740389668728493.webp" alt="" />

	                                    </a>
	                                </div>
	                                <div class="product-action-1">

	                                    <a aria-label="Add To Wishlist" class="action-btn" id="7" onclick="addToWishList(this.id)"><i class="fi-rs-heart"></i></a>

	                                    <a aria-label="Compare" class="action-btn" id="7" onclick="addToCompare(this.id)"><i class="fi-rs-shuffle"></i></a>

	                                    <a aria-label="Quick view" class="action-btn" data-bs-toggle="modal" data-bs-target="#quickViewModal" id="7" onclick="productView(this.id)"><i class="fi-rs-eye"></i></a>
	                            ...
	                            <div class="product-content-wrap">
	                                ...
	                                <h2><a href="https://digi-poly.id.vn/product/details/7/men-regular-fit-solid-button-down"> Men Regular Fit Solid Button Down </a></h2>
	            ...
	            <!--En tab two-->
	            <div class="tab-pane fade" id="category2" role="tabpanel" aria-labelledby="tab-two">
	                <div class="row product-grid-4">
	            ...
	            <!--En tab two-->
	            <div class="tab-pane fade" id="category1" role="tabpanel" aria-labelledby="tab-two">
	                <div class="row product-grid-4">
	            ...
	            <!--En tab two-->
	            <div class="tab-pane fade" id="category8" role="tabpanel" aria-labelledby="tab-two">
	                <div class="row product-grid-4">
	            ...
	            <!--En tab two-->
	            <div class="tab-pane fade" id="category10" role="tabpanel" aria-labelledby="tab-two">
	                <div class="row product-grid-4">
	            ...
	            <!--En tab two-->
	            <div class="tab-pane fade" id="category7" role="tabpanel" aria-labelledby="tab-two">
	                <div class="row product-grid-4">
	            ...
	            <!--En tab two-->
	            <div class="tab-pane fade" id="category9" role="tabpanel" aria-labelledby="tab-two">
	                <div class="row product-grid-4">
	                    ...
	                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
	                        <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
	                            <div class="product-img-action-wrap">
	                                <div class="product-img product-img-zoom">
	                                    <a href="https://digi-poly.id.vn/product/details/28/apple-iphone-13-(starlight,-128-gb)">
	                                        <img class="default-img" src="https://digi-poly.id.vn/upload/products/thambnail/1740391997743770.webp" alt="" />
	                                ...
	                                <div class="product-action-1">
	                                    ...
	                                    <a aria-label="Quick view" class="action-btn" data-bs-toggle="modal" data-bs-target="#quickViewModal" id="28" onclick="productView(this.id)"><i class="fi-rs-eye"></i></a>
	                                </div>
	                            ...
	                            <div class="product-content-wrap">
	                                ...
	                                <h2><a href="https://digi-poly.id.vn/product/details/28/apple-iphone-13-(starlight,-128-gb)"> APPLE iPhone 13 (Starlight, 128 GB) </a></h2>
	                                <div class="product-rate-cover">
	                                    <div class="product-rate d-inline-block">
	                                        <div class="product-rating" style="width: 90%"></div>
	                                    </div>
	            ...
	            <!--En tab two-->
	            <div class="tab-pane fade" id="category3" role="tabpanel" aria-labelledby="tab-two">
	                <div class="row product-grid-4">
	            ...
	            <!--En tab two-->
	            <div class="tab-pane fade" id="category11" role="tabpanel" aria-labelledby="tab-two">
	                <div class="row product-grid-4">
