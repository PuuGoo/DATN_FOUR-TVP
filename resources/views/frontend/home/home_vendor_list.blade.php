<div class="container">
    ...
    <div class="section-title wow animate__animated animate__fadeIn" data-wow-delay="0">
        ...
        <a class="show-all" href="https://digi-poly.id.vn/vendor/all">
            All Vendors
                ...
                <div class="vendor-img-action-wrap">
                    <div class="vendor-img">
                        <a href="vendor-details-1.html">
                            <img class="default-img" src="{{ asset('upload/no_image.jpg')}}" style="width:120px;height: 120px;" alt="" />
                        </a>
                    </div>
                ...
                <div class="vendor-content-wrap">
                    ...
                    <div class="vendor-info mb-30">
                        <ul class="contact-infor text-muted">
                            ...
                            <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-contact.svg')}}" alt="" /><strong>Call Us:</strong><span>0984004258</span></li>
                        </ul>
                    </div>
                ...
                <div class="vendor-content-wrap">
                    ...
                    <div class="vendor-info mb-30">
                        <ul class="contact-infor text-muted">
                            ...
                            <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-contact.svg')}}" alt="" /><strong>Call Us:</strong><span>4343434</span></li>
                        </ul>
                    </div>
        ...
        <div class="col-lg-3 col-md-6 col-12 col-sm-6 justify-content-center">
            <div class="vendor-wrap mb-40">
                <div class="vendor-img-action-wrap">
                    <div class="vendor-img">
                        <a href="vendor-details-1.html">
                            <img class="default-img" src="{{ asset('upload/vendor_images/202208060516logo0000.png')}}" style="width:120px;height: 120px;" alt="" />
                        </a>
                    </div>
                    <div class="product-badges product-badges-position product-badges-mrg">
                        <span class="hot">Mall</span>
                ...
                <div class="vendor-content-wrap">
                    ...
                    <div class="vendor-info mb-30">
                        <ul class="contact-infor text-muted">
                            ...
                            <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-contact.svg')}}" alt="" /><strong>Call Us:</strong><span>01578522545</span></li>
                        </ul>
                    </div>
        ...
        <div class="col-lg-3 col-md-6 col-12 col-sm-6 justify-content-center">
            <div class="vendor-wrap mb-40">
                <div class="vendor-img-action-wrap">
                    <div class="vendor-img">
                        <a href="vendor-details-1.html">
                            <img class="default-img" src="{{ asset('upload/vendor_images/202208060514sony-vector-logo-small.png')}}" style="width:120px;height: 120px;" alt="" />
                        </a>
                    </div>
                    <div class="product-badges product-badges-position product-badges-mrg">
                        <span class="hot">Mall</span>
                ...
                <div class="vendor-content-wrap">
                    ...
                    <div class="vendor-info mb-30">
                        <ul class="contact-infor text-muted">
                            ...
                            <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-contact.svg')}}" alt="" /><strong>Call Us:</strong><span>018652586552</span></li>
                        </ul>
                    </div>
