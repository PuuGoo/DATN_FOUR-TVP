...
<form method="post" action="{{ url('/checkout/store') }}" id="checkoutForm">
            ...
            <div class="col-lg-5">
                ...
                <div class="payment ml-30">
                    ...
                    <div class="custome-radio">
                        ...
                        <div class="custome-radio">
                            <input class="form-check-input" value="COD" type="radio" name="payment_option" id="radioCOD" checked>
                            <label class="form-check-label" for="radioCOD">COD</label>
                            <!-- 
                            <input class="form-check-input" value="VNPAY" type="radio" name="payment_option" id="radioVNPAY">
                            <label class="form-check-label" for="radioVNPAY">VNPAY</label>

                            <input class="form-check-input" value="MOMO" type="radio" name="payment_option" id="radioMOMO">
                            <label class="form-check-label" for="radioMOMO">MOMO</label> -->
                        </div>
