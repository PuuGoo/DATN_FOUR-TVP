                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('site.setting.update', $siteSetting->id ?? 0) }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img id="showImage" src="{{ asset('upload/logo/'.($siteSetting->logo ?? 'default_logo.png')) }}" alt="Logo" style="width:100px; height:100px;">
                                    </div>
                                </div>
