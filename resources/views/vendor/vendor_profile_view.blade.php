						...
						<div class="card-body">
							<div class="d-flex flex-column align-items-center text-center">
								...
								<div class="mt-3">
									...
									<p class="text-muted font-size-sm">Campbell Ave undefined</p>
				...
				<div class="col-lg-8">
					<div class="card">
						<div class="card-body">
							...
							<form method="post" action="https://digi-poly.id.vn/vendor/profile/store" enctype="multipart/form-data">
